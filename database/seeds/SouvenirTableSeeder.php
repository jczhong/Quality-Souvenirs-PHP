...
class SouvenirTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $souvenir->save();
        $souvenir = new App\Souvenir(['Name' => 'Test Maori Gifts2', 'Description' => 'This is a test product', 'Price' => 17.8, 'Popularity' => 7, 'CategoryID' => 1, 'SupplierID' => 1]);
        $souvenir->save();
        $souvenir = new App\Souvenir(['Name' => 'Test Jewellery2', 'Description' => 'This is a test product', 'Price' => 66.8, 'Popularity' => 8, 'CategoryID' => 2, 'SupplierID' => 1]);
        $souvenir->save();
        $souvenir = new App\Souvenir(['Name' => 'Test Art2', 'Description' => 'This is a test product', 'Price' => 80.9, 'Popularity' => 3, 'CategoryID' => 3, 'SupplierID' => 1]);
        $souvenir->save();
        $souvenir = new App\Souvenir(['Name' => 'Test Homeware2', 'Description' => 'This is a test product', 'Price' => 34.5, 'Popularity' => 9, 'CategoryID' => 4, 'SupplierID' => 2]);
        $souvenir->save();
        $souvenir = new App\Souvenir(['Name' => 'Test Clothing2', 'Description' => 'This is a test product', 'Price' => 17.8, 'Popularity' => 10, 'CategoryID' => 5, 'SupplierID' => 2]);
        $souvenir->save();
        $souvenir = new App\Souvenir(['Name' => 'Test Bags2', 'Description' => 'This is a test product', 'Price' => 9.99, 'Popularity' => 12, 'CategoryID' => 6, 'SupplierID' => 2]);
        $souvenir->save();
    }
}
